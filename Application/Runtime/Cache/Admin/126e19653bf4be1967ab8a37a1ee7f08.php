    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box layui-form">
            <table class="layui-table admin-table">
                ...
                <tbody id="content">
                <?php if(empty($man["model"])): ?><tr>
                        <td colspan="4">没有任何数据</td>
                    </tr>
                    <?php else: ?>
                    <?php if(is_array($man["model"])): foreach($man["model"] as $k=>$vo): if(!empty($vo)): ?><tr>
                                <td><input type="checkbox"  lay-skin="primary"></td>
                                <td>
                                    <?php switch($k): case "left": ?>左面<?php break; case "right": ?>右面<?php break; case "front": ?>前面<?php break; case "behind": ?>后面<?php break; default: endswitch;?>
                                </td>
                                <td><img src="/leshop<?php echo ($vo); ?>" width="100px" height="100px"/></td>
                                <td><button class="layui-btn layui-btn-small" deal="del" aa="<?php echo ($man["sex"]); ?>" pos="<?php echo ($k); ?>" ><i class="layui-icon"></i></button></td>
    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box layui-form">
            <table class="layui-table admin-table">
                ...
                <tbody id="content">
                <?php if(empty($woman["model"])): ?><tr>
                        <td colspan="4">没有任何数据</td>
                    </tr>
                    <?php else: ?>
                    <?php if(is_array($woman["model"])): foreach($woman["model"] as $k=>$vo): if(!empty($vo)): ?><tr>
                                <td><input type="checkbox"  lay-skin="primary"></td>
                                <td>
                                    <?php switch($k): case "left": ?>左面<?php break; case "right": ?>右面<?php break; case "front": ?>前面<?php break; case "behind": ?>后面<?php break; default: endswitch;?>
                                </td>
                                <td><img src="/leshop<?php echo ($vo); ?>" width="100px" height="100px"/></td>
                                <td><button class="layui-btn layui-btn-small" deal="del" aa="<?php echo ($woman["sex"]); ?>" pos="<?php echo ($k); ?>" ><i class="layui-icon"></i></button></td>
                            </tr><?php endif; endforeach; endif; endif; ?>
                </tbody>
            </table>
        </div>
    ...
    <form class="layui-form" action="javascript:;" id="data_forms">
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block" style="width: 50%">
                <div id="upload-5951268aa0d10" class="xb-uploader">
    <div class="queueList">
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        pick: {
            id: "#upload-5951268aa0d10 .filePicker",
            label: '点击选择文件',
            multiple : true
        },
        dnd: "#upload-5951268aa0d10 .queueList",
        paste: document.body,
        // accept: {
        //     title: 'Images',
        ...
        chunked: true,
        server: "<?php echo U('Admin/Shop/ajax_upload');?>",
        fileNumLimit: 1,
    ...
    // 添加“添加文件”的按钮，
    uploader.addButton({
       id: "#upload-5951268aa0d10 .filePicker2",
       label: '继续添加'
    });
    ...
    function updateStatus() {
        ...
        if ( state === 'ready' ) {
            ...
            if (fileCount==stats.successNum && stats.successNum!=0) {
                $('#upload-5951268aa0d10 .webuploader-element-invisible').remove();
            }
        }
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'ready':
                ...
                $( "#upload-5951268aa0d10 .filePicker2" ).removeClass( 'element-invisible');
            ...
            case 'uploading':
                $( "#upload-5951268aa0d10 .filePicker2" ).addClass( 'element-invisible' );
                $progress.show();
                $upload.text( '暂停上传' );
                break;
...
<script>
    var BASE_URL = '/leshop/Public/statics/webuploader-0.1.5';
</script>
            ...
            switch (deal){
                case 'del':
                    ...
                    layer.confirm('你确定要删除吗？', {
                        ...
                        //按钮【按钮一】的回调
                        $.ajax({
                            url:"/leshop/index.php/Admin/Model/deleteModel",
                            type:'post',
                            data:{'sex':id,'pos':pos},
                            async:true,
                ...
                case 'upload':
                    $.ajax({
                        url:"/leshop/index.php/Admin/Model/uploadModel",
                        type:'post',
