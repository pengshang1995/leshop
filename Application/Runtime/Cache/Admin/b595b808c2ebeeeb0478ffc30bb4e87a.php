...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">乐搭配商城</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
            <span class="logo navbar-slogan f-l mr-10 hidden-xs">后台管理系统v1.0</span>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <?php if(is_array($nav)): foreach($nav as $key=>$vo): ?><dl id="menu-admin">
                <dt><?php echo ($vo["title"]); ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
                <dd>
                    <ul>
                        <?php if(is_array($vo["child"])): foreach($vo["child"] as $key=>$value): ?><li><a data-href="<?php echo ($value["href"]); ?>" data-title="<?php echo ($value["title"]); ?>" href="javascript:void(0)"><?php echo ($value["title"]); ?></a>
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="<?php echo U('Index/weclome');?>">我的桌面</span>
                    <em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="<?php echo U('Index/weclome');?>" ></iframe>
        </div>
    </div>
</section>
