        ...
        <div class="content">
            <div class="content_top">
                <div class="back-links">
                    <p><a href="<?php echo U('Index/index');?>">主页</a> >>>> <a href="#"><?php echo ($good["goodname"]); ?></a></p>
                </div>
                <div class="clear"></div>
            </div>
                ...
                <div class="cont-desc span_1_of_2">
                    <div class="product-details">
                                ...
                                <div id="products_example">
                                    <div id="products">
                                        <div class="slides_container">
                                            <?php if(is_array($goodimg)): $i = 0; $__LIST__ = $goodimg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="#" target="_blank"><img src="<?php echo ($vo["savepath"]); ?>" alt=" " /></a><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </div>
                                        <ul class="pagination">
                                            <?php if(is_array($goodimg)): $i = 0; $__LIST__ = $goodimg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="#"><img src="<?php echo ($vo["savepath"]); ?>" alt=" " /></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="desc span_3_of_2">
                            <h2><?php echo ($good["goodname"]); ?> </h2>
                            <p><?php echo ($good["gooddesc"]); ?></p>
                            <div class="price">
                                <p>价格: <span>$<?php echo ($good["goodprice"]); ?></span></p>
                            </div>
                            <div class="available">
                                <p>可选项:</p>
                                <ul>
                                    <li>商品规格<select name="size" id="size">
                                        <?php if(is_array($size)): $i = 0; $__LIST__ = $size;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["size"]); ?>"><?php echo ($vo["size"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            ...
                            <div class="share-desc">
                                <div class="button"><span><a href="javascript:;" aa="<?php echo ($good["id"]); ?>">加入购物车</a></span></div>
                                <div class="clear"></div>
                            </div>
                            <div class="wish-list">
                                <ul>
                                    <li class="wish"><a href="#">加入我的衣架</a></li>
                                    <li class="wish"><a href="#">衣服尺码计算</a></li>
                                    <li class="compare"><a href="#">加入我的搭配</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div id="horizontalTab">
                            ...
                            <div class="resp-tabs-container">
                                ...
                                <div class="review">
                                    ...
                                    <ul>
                                        <li>Price :<a href="#"><img src="/leshop/Public/images/price-rating.png" alt="" /></a></li>
                                        <li>Value :<a href="#"><img src="/leshop/Public/images/value-rating.png" alt="" /></a></li>
                                        <li>Quality :<a href="#"><img src="/leshop/Public/images/quality-rating.png" alt="" /></a></li>
                                    </ul>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
            ...
            switch ($(this).html()){
                case '衣服尺码计算':
                    layer.open({
                        ...
                        content:'/leshop/index.php/Home/Good/size'
                    });
                    break;
                case '加入购物车':
                    id=$(this).attr('aa');
